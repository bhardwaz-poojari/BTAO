...
function innovativeapps() {
 ...
 <div id="demo">
    ...
    <div class="container">
      ...
      <div class=" col-lg-6  py-5 py-lg-0 order-2 order-lg-1 animated bounceInRight slow" data-aos="fade-right">
            <?php
        if(isset($_SESSION['loginid']))
        {
        ...
        ?>
        <h1>CSE PPT'S are  Collected From Students of Different Colleges </h1>
       <!-- <h2>We are team of talanted designers making websites with Bootstrap</h2>
          <h2>May Change Your Life</h2>-->
        <a href="#ppts" class="btn-get-started" style="font-family: 'Josefin Sans', sans-serif;">Let's See</a>
      </div>
      <div class="col-lg-6 order-1 order-lg-2 entrance-img animated bounceInLeft slow" data-aos="fade-left">
...
$( ".wow" ).addClass( "fadeInUp" );
  ...
  <section  id="ppts" align="center">
        <form class="form-inline md-form form-sm mt-0"  style="margin-left:15%;padding:50px;">
          <i class="fas fa-search" aria-hidden="true" style="color:rgb(19,0,26);"></i>
          <input class="form-control form-control-sm ml-3 w-75"   id="searchbar"  type="text"  onkeyup="search_animal()" placeholder="Search by Subject Name" aria-label="Search">
         
        </form>
        
<?php
        $query="select * from `ppts` where `branch`='cse'" ;
...
echo '<div class="container services wow bounceIn" data-wow-delay="0.5s" style="padding:20px;"  >
    <div class="notice notice-lg notice-success">
       <strong style="color:darkgreen;">Subject:'.$row['subject'].'<br></strong>
       <p style="color:rgb(19,0,27);"> This  PPT  Consists of '.$row['topics'].'
        </p>
        <a href="'.$row['pptdrivelink'].'" class="btn btn-dark" >Download For Free </a>
...
?>     
   ...
   <section style="padding:100px;font-family: 'Josefin Sans', sans-serif;" class="wow bounceIn" data-wow-delay="0.6s">
     ...
     <a href="#ppts" class="btn btn-danger btn-lg">PPT'S</a>
     <a href="objective.php" class="btn btn-success btn-lg">OBJECTIVES</a>
 </section>
